...
class Preorder {
	...
	public function __construct() {
		...
		add_filter( 'bulk_actions-edit-sdevs_preorder', array( $this, 'remove_bulk_action' ) );
		add_filter( 'post_row_actions', array( $this, 'post_row_actions' ), 10, 2 );
		add_action( 'add_meta_boxes', array( $this, 'create_meta_boxes' ) );
		add_filter( 'manage_edit-sdevs_preorder_columns', array( $this, 'add_custom_columns' ) );
		add_action( 'manage_sdevs_preorder_posts_custom_column', array( $this, 'add_custom_columns_data' ), 10, 2 );
	}
	...
	public function create_post_type() {
		$labels = array(
			...
			'not_found'         => __( 'No preorders found.', 'sdevs_preorder' ),
		);
	...
	public function create_meta_boxes() {
		...
		add_meta_box(
			...
			'Details',
			array( $this, 'preorder_meta_fields' ),
			'sdevs_preorder',
			'normal',
			'default'
		);
		...
		add_meta_box(
			...
			array( $this, 'preorder_customer_info' ),
			'sdevs_preorder',
			'side',
			'default'
		);
